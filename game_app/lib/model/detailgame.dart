...
// part file untuk code generation [cite: 401]
part 'detailgame.g.dart';

// Model untuk Minimum System Requirements [cite: 405, 407]
@JsonSerializable()
...
// Model untuk Screenshot [cite: 442, 444]
@JsonSerializable()
class Screenshot {
  final int id;
  final String image;
...
// Model utama Detail Game [cite: 460]
@JsonSerializable()
class DetailGame {
  final int id;
  final String title;
